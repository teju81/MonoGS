...
RUN_RECORD_ROSBAG="ros2 bag record --compression-mode message --compression-format zstd -o /root/code/output/my_bag /Front2Gui /Back2LoopClosure"
...
if [ $? != 0 ]; then
    ...
    tmux send-keys -t 3 "$RUN_RECORD_ROSBAG" C-m  # Bottom-right pane
